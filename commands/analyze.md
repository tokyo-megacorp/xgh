---
name: xgh-analyze
description: Run the xgh context analysis loop. Reads ~/.xgh/inbox/, classifies and extracts structured memories, writes to MAGI workspace, and generates a daily digest. Invoked by the scheduler every 30 minutes.
---
