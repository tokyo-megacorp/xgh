...
```
[STORE] path="session/<cli>-dispatch.md" title="<CLI_LABEL> dispatch outcome" body="<CLI_LABEL> dispatch: <type> | model: <model> | isolation: <mode> | <outcome summary>" tags="session,<cli>"
```
