---
name: xgh-analyze
description: Run the xgh context analysis loop. Reads ~/.xgh/inbox/, classifies and extracts structured memories, stores to workspace memory, and generates a daily digest. Invoked by the scheduler every 30 minutes.
---
