...
|------|-------------|-------------|
| [**lossless-claude**](https://github.com/ipedro/lossless-claude) | Persistent memory across sessions | Manual setup, no cross-session recall |
...
| Layer | Tool | Role |
|-------|------|------|
| Memory | [lossless-claude](https://github.com/ipedro/lossless-claude) | Persistent cross-session recall via MCP |
...
|---------------|-------------|------------------|
| Persistent memory | [lossless-claude](https://github.com/ipedro/lossless-claude) | [@ipedro](https://github.com/ipedro) |
...
| **The glue** | **xgh** | [@ipedro](https://github.com/ipedro) |
