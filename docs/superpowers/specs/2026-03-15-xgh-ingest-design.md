...
Daily human-readable summary at `.xgh/digests/YYYY-MM-DD.md`, accumulated throughout the day:

```markdown
# Digest — 2026-03-15

## Passcode Feature
- **[SPEC_CHANGE]** PIN entry now requires biometric fallback (14:30)
- **[DECISION]** Going with approach B for token storage (11:15)
- **[WIP]** Lucas working on backend endpoint (10:00)

## Awaiting Your Reply (3)
- 🔴 PR review: passcode-service#142 from Lucas (31h)
- 🟡 Slack: @pedro question about token expiry in #ptech-eng (6h)
- 🟢 Jira: PTECH-456 assigned to you (1h)

## Awaiting Their Reply (1)
- 🟡 You asked @lucas about API contract in #ptech-eng (28h)
```
