...
- Machine fix (applied 2026-03-17): deleted `~/.claude/plugins/cache/tokyo-megacorp/xgh/1.0.0/commands/`
...
- **Workaround:** Delete `~/.claude/plugins/cache/tokyo-megacorp/xgh/1.0.0/commands/` to remove `xgh-*` duplicates
